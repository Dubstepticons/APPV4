...
> **Note:** The legacy `USE_NEW_PANEL1` / `USE_NEW_PANEL2` feature flags have been removed.
> Decomposed panels are always active; use the standard deployment pipeline to roll forward/back.
