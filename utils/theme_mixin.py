...
class ThemeAwareMixin:
    ...
    def refresh_theme(self) -> None:
        ...
        try:
            ...
            pass  # Silently ignore stylesheet build errors
        ...
        try:
            ...
            pass  # Silently ignore child refresh errors

        # Step 3: Custom refresh logic (hook for subclasses)
        try:
            self._on_theme_refresh()
        except Exception:
            pass  # Silently ignore custom refresh errors
        ...
        try:
            ...
            pass  # Silently ignore repaint errors
